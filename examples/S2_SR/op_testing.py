...
if __name__ == '__main__':
    plot_sparsity = True # To plot the sparsity pattern of the operators
    ...
    if plot_sparsity:
        ...
        plt.spy(A_sparse, markersize=0.5)
        n_rows, n_cols = A_sparse.shape
        plt.gca().set_aspect(n_cols/n_rows) 
        print("Sparsity pattern of A")
        plt.xlabel("High resolution index", fontsize=25, fontweight = 'bold')
        plt.ylabel("Low resolution index", fontsize=25, fontweight = 'bold')
        plt.show()
